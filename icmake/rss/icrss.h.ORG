...
/*
    ...
    structure of the binary file:
        ...
        offset of the filenames area        (int32_t) (end of BinHeader)
        offset of first instr. to execute   (int32_t)
    ...
    The runtime stack contains elements of type Variable. When a element is popped,
    ...
    op_call funnr       funnr is a byte (see enum FunNr)
    ...
    op_inc              increment int variable, varnr is int16_t argument
    op_dec              decrement int variable, varnr is int16_t argument
    op_call int16_t       call function at offset
    op_frame int8_t ...   make function frame, for int8_t variables
    ...
    loc1 of type int, and loc2 of type string, is:
                ...
                op_frame    2, e_int, e_str     (opcode and three int8_t's)

    Functions printf, gr_fprintf
    -------------------------
    ...
    to that of the functions printf and gr_fprintf.
...
BinHeader *readheader (FILE *, size_t);
...
int      rs_getOptIndex(void);                  /*  ICCE getopt functions   */
int      ic_getopt(int *, char **);
char     *ic_getoptval(int *, char **);

#define  getoptindex rs_getOptIndex             /*  and their mappings      */
#define  getopt      ic_getopt
#define  getoptval   ic_getoptval

char     *getstring (FILE *, int32_t, size_t);
...
int16_t    getint16 (FILE *);

Opcode  getopcode (FILE *);

uint16_t    getvar(FILE *, BinHeader *, Variable **);

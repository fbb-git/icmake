...
void usage(char const *progname)
{
    ...
    "      --mainih (-m) ihfile - the top directory's main .ih file "
                                                            "(main.ih)\n"
    "      --no-gch             - do not inspect/remove .gch precompiled "
                                                            "headers\n"
    "                             (rm is implied by icmonf's PRECOMP "
                                                            "specification\n"
    "      --no-use-all         - do not inspect USE_ALL files (inspecting\n"
    "                             use-all files is implied if icmconf "
                                                            "contains\n"
    "                             a USE_ALL specification)\n"
